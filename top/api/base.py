...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20180409"
...
class RestApi(object):
    ...
    def getResponse(self, authrize=None, timeout=30):
        ...
        if  "error_response" in jsonobj:
            ...
            error.application_host = response.headers['Application-Host']
            error.service_host = response.headers["Location-Host"]
            raise error
        return jsonobj
